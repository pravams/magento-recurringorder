 ...
 */
class Pravams_MySubscription_Model_Msorder extends Mage_Core_Model_Abstract
{
    ...
    protected function _construct(){
        $this->_init('mysubscription/msorder');
    }
...
//        $item = false;
    ...
    public function setMsAddress($msaddress, $address, $type){
        $msaddress->setMsquoteId($this->getId())
                ...
                ->setGrandTotal($this->getSubtotal() + $address->getShippingAmount())
                ->setBaseGrandTotal($this->getBaseSubtotal() + $address->getShippingAmount())
                ;
