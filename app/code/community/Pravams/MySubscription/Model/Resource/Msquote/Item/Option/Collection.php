 ...
 */
class Pravams_MySubscription_Model_Resource_Msquote_Item_Option_Collection extends Mage_Core_Model_Resource_Db_Collection_Abstract
{
    /*
     ...
     *
     * @return Pravams_MySubscription_Model_Resource_Msquote_Item_Option_Collection
     * */
    ...
    public function addItemFilter($item){
        ...
        } elseif ($item instanceof Pravams_MySubscription_Model_Msquote_Item){
    ...
    public function getOptionsByItem($item){
        if ($item instanceof Pravams_MySubscription_Model_Msquote_Item) {
            $itemId = $item->getId();
        } else {
            $itemId = $item;
        }
