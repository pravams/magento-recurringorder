 ...
 */
class Pravams_Payment_Model_Method_Purchaseorder extends Mage_Payment_Model_Method_Purchaseorder
{
    /*
    ...
    public function isApplicableToQuote($quote, $checksBitMask){
        ...
        if ($checksBitMask & self::CHECK_ZERO_TOTAL) {
            ...
            if(Mage::helper('mysubscription')->hasSubscriptionItems() && Mage::helper('pravams_payment')->isPoEnabled()){
