 ...
 */
class Pravams_Payment_Model_Method_Ccsave extends Mage_Payment_Model_Method_Ccsave
{
    /*
    ...
    public function isApplicableToQuote($quote, $checksBitMask){
        ...
        if ($checksBitMask & self::CHECK_ZERO_TOTAL) {
            ...
            if(Mage::helper('mysubscription')->hasSubscriptionItems() && Mage::helper('pravams_payment')->isCcEnabled()){
